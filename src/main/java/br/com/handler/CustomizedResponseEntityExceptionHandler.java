...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(ConditionsFaildedException.class)
	public final ResponseEntity<ExceptionResponse> handleConditionsFaildedException(Exception ex, WebRequest request) {
